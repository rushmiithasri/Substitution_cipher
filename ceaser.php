...
<nav style="background-color: #5f5050">
  <div class="nav-wrapper">
    <a href="home.php" class="brand-logo" style="padding: 5px;">Substitution Cipher</a>
...
<textarea id="p" name="p" rows="4" cols="50" style="color:white; font-family: cursive;max-width: 300px;">attack at dawn</textarea> 
<p style="color: white;">  Shift:
 <select id="key" name="key" size="1" style="display: inherit;max-width: 60px;max-height: 35px;background-color: #21ada0;font-family: cursive;"> 
  ...
  <button onclick="Encrypt_Ceaser()"><i class="small material-icons">enhanced_encryption</i></button>
<button onclick="Decrypt_Ceaser()"><i class="small material-icons">lock_open</i></button></p> 
<p style="color: white;">Ciphertext<br><br><textarea id="c" name="c" rows="4" cols="50" style="color:white; font-family: cursive;max-width: 300px;"></textarea></p> 
</div>
<script type="text/javascript"> 
function Encrypt_Ceaser() {
